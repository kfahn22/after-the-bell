    ...
    wfc.setup = () => {
        wfc.createCanvas(300, 300);
            ...
            // } else {
                ...
                tiles[0] = new Tile(tileImages[0], ["CA", "AD", "AA", "AA"]);
                tiles[1] = new Tile(tileImages[1], ["CA", "AB", "AA", "AA"]);
                tiles[2] = new Tile(tileImages[2], ["DB", "BC", "BB", "BB"]);
                tiles[3] = new Tile(tileImages[3], ["DB", "BA", "BB", "BB"]);
                tiles[4] = new Tile(tileImages[4], ["DB", "BC", "AA", "AA"]);
                tiles[5] = new Tile(tileImages[5], ["CA", "AD", "BB", "BB"]);
